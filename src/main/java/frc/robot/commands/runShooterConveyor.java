...
public class runShooterConveyor extends ParallelCommandGroup {
  /** Creates a new runShooterConveyor. */


  public runShooterConveyor(Conveyor m_Conveyor, shooter m_Shooter) {
